...
//
  ...
  //{
	//// Fill tempa with prior 4 bytes of roundKey
    ///*for(j = 0; j < 4; ++j)
    ////{
...
//
      //// Function RotWord()
      ///*{
        //tempa[0] = RoundKey[(i-1) * 4 + 1];
        //tempa[1] = RoundKey[(i-1) * 4 + 2];
        //tempa[2] = RoundKey[(i-1) * 4 + 3];
        //tempa[3] = RoundKey[(i-1) * 4 + 0];
      //}*/
//
...
//
      //// Function Subword()
		//
  //
        //tempa[i% Nk] = getSBoxValue(RoundKey[((i+1)%4) + (i-(i%4)-4)]);
		       //// tempa[i% Nk] = getSBoxValue(RoundKey[i-4]);
//
//
	  //if (!(i % Nk))
	   //{
